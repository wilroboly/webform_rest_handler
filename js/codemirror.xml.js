...
(function ($, Drupal) {
     ...
     */
    Drupal.behaviors.codemirror_xml = {
        attach: function (context) {
            // console.log('the codemirror shit is on!')
            ...
            $(context).find('textarea.js-webform-rest-codemirror').once('webform-codemirror').each(function () {
                var $input = $(this);
    ...
    $(document).on('state:visible state:visible-slide', function (event) {
        var $element = $(event.target).parent().find('.js-webform-rest-codemirror');
